					...
					<div class="group perspective-1000 relative flex flex-col items-center">
						...
						<div
							class="relative z-30 mt-6 w-full max-w-[280px] text-center md:pointer-events-none
                                    md:absolute md:top-0 md:left-1/2 md:w-64 md:max-w-full
						...
						>
							...
							<!-- Bookmark Card -->
							<div
								class="pointer-events-auto relative overflow-hidden rounded-sm bg-[#f5e6d3] p-6 pb-8
                                       shadow-xl after:absolute after:top-0 after:left-0 after:z-0 after:h-full after:w-full after:bg-[url('https://www.transparenttextures.com/patterns/aged-paper.png')]
                                       after:opacity-50 md:rounded-t-md md:rounded-b-3xl md:border-t-4 md:border-[var(--color-camo-brown)]"
							>
								<!-- Decorative Ribbon/String Hole -->
								<div
									class="absolute top-[-10px] left-1/2 z-20 hidden h-4 w-4 -translate-x-1/2 rounded-full border-2 border-[#d4b483] bg-[#1a0f0a] shadow-inner md:block"
								></div>
